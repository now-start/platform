...
| 모듈 | 역할 | 기본 포트 | 현재 버전 |
| --- | --- | ---: | --- |
| `config` | Spring Cloud Config Server | `8888` | `2.1.15` |
| `eureka` | Eureka Server | `8761` | `2.4.10` |
| `admin` | Spring Boot Admin Server | `9090` | `2.11.8` |
| `gateway` | Spring Cloud Gateway | `8000` | `6.1.1` |
...
```bash
./gradlew :gateway:bootBuildImage --imageName=ghcr.io/now-start/gateway:6.1.1
```
